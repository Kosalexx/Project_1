...
int_2 = int(float_1)  # преобразование числа в целочисленный тип данных,
print(int_2)  # число округляется в меньшую сторону

float_2 = float(int_1)  # преобразование числа в число с плавающей точкой
print(float_2)

float_3 = 10 / 5  # в результате деления одного целого числа на другое
...
print(bool(1), bool(0), bool(5), bool('asd'))  # возвращает False если в bool()
# передается 0 и True в остальных случаях
...
text = 'hello world'
print(type(text))
print(text[0] + text[3] + text[6] + text[6])  # str объекты индексируются,
# можно собрать другое "слово" зная индексы
...
# удаление лишних символо в конце и начале строки (по умолчанию - пробел, иное
# - передается в кач-ве аргумента метода
text_6 = '    Какой-то текст и много пробелов в конце и начале      '.strip()
print(text_6)

text_7 = 'Здесь просто должен быть какой-то текст'
list_1 = text_7.split()  # разбивает строку на слова по аргументу
# передаваемому в метон(по умолч. - пробел)
print(list_1)
