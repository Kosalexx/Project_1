...
my_tuple = (1,)  # создание кортежа с одним элементом
...
print(info.index(28), tuple_text.count('l'))
# методы, такие как count() и index()
print(len(tuple_text), sum(my_tuple_2),
      max(my_tuple_2), min(my_tuple_2))  # встроенные функции
