...
print(my_set_1, my_set_2, my_set_3)  # pамороженные множества являются неизменяемыми
# над ними можно проводить те же операции что и над обычными множествами, кроме изменяющих сожержимое
