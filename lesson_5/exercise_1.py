...
слова разделить тремя символами (пробел, восклицательный знак и ещё пробел), вывести итоговое предложение на экран.
Задание необходимо выполнить тремя разными способами форматирования.
"""

text = input('Введите предложение из двух слов: ')  # ввод данных от пользователя
